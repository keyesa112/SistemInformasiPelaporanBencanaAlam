          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="assets/img/portfolio/product-1.png" alt="">
              </div>
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Nama Bencana</strong> <span>Banjir</span></li>
                <li><strong>Pelapor</strong> <span>Waringin</span></li>
                <li><strong>Lokasi</strong> <span>Banten</span></li>
                <li><strong>Waktu Kejadian</strong> <span> Kamis, 23 Juli 2022 13.20 WIB</span></li>
              </ul>
            </div>
          </div>
