        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-3">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Nama Bencana</strong> <span>Gunung Meletus</span></li>
                <li><strong>Pelapor</strong> <span>Waskito</span></li>
                <li><strong>Lokasi</strong> <span>D.I. Yogyakarta</span></li>
                <li><strong>Waktu Kejadian</strong> <span> Kamis, 29 Juli 2022 19.07 WIB</span></li>
              </ul>
            </div>
          </div>
